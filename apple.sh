...
printf "$ORANGE\n"                              
printf "$ORANGE\n"         
printf "$ORANGE                          Apple Validiator - 2K19       \n"                        
...
malhadi_appleval() {
  ...
  footer="[Sultan_IRBIRBEL - AppleValid 2019] $(($duration % 60))sec.\n"
...
getKey() {
  echo "=============== Robot Butuh Istirahat Juga Bos =================="
  wait
...
echo "+==========+ UDAH DIKASIH JANGAN NGELUNJAK BANGSAT - AppleID Validator 2019 - SULTAN_IRBIRBEL +==========+"
